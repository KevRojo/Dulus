"""Thread-safe task store: in-memory dict persisted to .falcon/tasks.json."""
...
# Tasks are keyed by ID, stored per session in <cwd>/.falcon/tasks.json
...
def _tasks_file() -> Path:
    return Path.cwd() / ".falcon-context" / "tasks.json"
